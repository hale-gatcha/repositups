...
// SQL query to select all data from userfacultyauditlog table
$sql = "SELECT auditLogID, modifiedBy, targetUserID, targetFacultyID, actionType, timestamp FROM userfacultyauditlog";
...
<head>
    ...
    <title>User Faculty Audit Log</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <div class="container-fluid flex-grow-1">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row["auditLogID"] . "</td>";
                echo "<td>" . $row["modifiedBy"] . "</td>";
                echo "<td>" . $row["targetUserID"] . "</td>";
                echo "<td>" . $row["targetFacultyID"] . "</td>";
                echo "<td>" . $row["actionType"] . "</td>";
                echo "<td>" . $row["timestamp"] . "</td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
            echo "<p class='no-records'>No records found in the user faculty audit log.</p>";
        }
