...
// SQL query to select all data from researchentrylog table
$sql = "SELECT entryLogID, performedBy, actionType, researchID, timestamp FROM researchentrylog";
...
<head>
    ...
    <title>Research Entry Log</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
...
<body>
    ...
    <div class="container-fluid flex-grow-1">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p class='no-records'>No records found in the research entry log.</p>";
        }
