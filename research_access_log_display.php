...
require_once 'session_check.php';  // This will handle session start
...
// SQL query to select all data from researchaccesslog table
$sql = "SELECT accessLogID, researchID, userID, accessTimeStamp FROM researchaccesslog";
...
<head>
    ...
    <title>Research Access Log</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <div class="container-fluid flex-grow-1">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row["accessLogID"] . "</td>";
                echo "<td>" . $row["researchID"] . "</td>";
                echo "<td>" . $row["userID"] . "</td>";
                echo "<td>" . $row["accessTimeStamp"] . "</td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
            echo "<p class='no-records'>No records found in the research access log.</p>";
        }
